      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 w-full">
        <div className="relative">
          ...
          <a
            ...
            className="absolute top-0 right-0 bg-[#1a73e8] hover:bg-[#1557b0] text-white px-4 py-2 rounded-full text-sm font-medium flex items-center gap-2 transition-colors shadow-md"
          >
