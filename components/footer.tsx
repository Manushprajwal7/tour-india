    ...
    <footer className="bg-[#1e3a5f] text-white ">
      ...
      <div className="max-w-5xl mx-auto px-4 py-12">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          {/* mail us */}
          <div>
            <h4 className="font-bold text-lg mb-4">Mail Us</h4> 
            ...
            <div className="flex">
              <input
                ...
                className="flex-1 px-4 py-2 rounded-l-lg bg-white/10 border border-white/20 text-white placeholder:text-white/50 focus:outline-none focus:border-[#c9a227] text-sm"
              />
              <button className="px-4 py-2 bg-[#c9a227] rounded-r-lg hover:bg-[#b8922a] transition-colors">
