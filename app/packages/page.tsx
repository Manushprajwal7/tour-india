    ...
    <main className="min-h-screen">
      ...
      >
        ...
        <div className="max-w-6xl mx-auto px-4 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-24 xl:gap-32 pt-12 max-w-7xl mx-auto px-6" style={{ transform: "translateY(-80px)" }}>
            {/* First Package Card - Goa Beach Paradise */}
            <div className="package-card-container-goa">
              <motion.div
                initial={{ opacity: 0, y: 30 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
            ...
            <div className="package-card-container-andhra">
              <motion.div
                initial={{ opacity: 0, y: 30 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
      ...
      <section
        ...
        className="py-20 relative overflow-hidden mt-0 min-h-screen bg-[url('/mobile_view.png')] md:bg-[url('/discover.png')] bg-[length:100%_100%] bg-center bg-no-repeat"
        style={{
          width: "100vw",
          marginLeft: "calc(-50vw + 50%)",
          marginRight: "calc(-50vw + 50%)",
      ...
      >
        ...
        <div className="max-w-6xl mx-auto px-4 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-24 xl:gap-32 pt-12 max-w-7xl mx-auto px-6"  style={{ transform: "translateY(-70px)" }}>
            {/* Kerala Hill Station */}
            <div className="package-card-container-kerala-hills">
              <motion.div
                initial={{ opacity: 0, y: 30 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
            ...
            {/* Coorg */}
            <div className="package-card-container-coorg">
              <motion.div
                initial={{ opacity: 0, y: 30 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
      ...
      >
        ...
        <div className="max-w-6xl mx-auto px-4 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-24 xl:gap-32 pt-12 max-w-7xl mx-auto px-6">
            {/* Pondicherry */}
            <div className="package-card-container-pondi">
              <motion.div
                initial={{ opacity: 0, y: 30 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
            ...
            {/* Ooty */}
            <div className="package-card-container-ooty">
              <motion.div
                initial={{ opacity: 0, y: 30 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
